...
if (empty($dados['cadnome'])) {
...
} elseif (empty($dados['cadendereco'])) {
    ...
    $query_usuario_pes = "SELECT id_user FROM tbusuarios WHERE email=:email LIMIT 1";
    ...
    if (($result_usuario) and ($result_usuario->rowCount() != 0)) {
        ...
        $query_usuario = "INSERT INTO tbusuarios (nome, email, endereco, telefone, senha, chave) VALUES (:nome, :email, :telefone, :endereco, :senha, :chave)";
        ...
        $cad_usuario->bindParam(':endereco', $dados['cadendereco'], PDO::PARAM_STR);
