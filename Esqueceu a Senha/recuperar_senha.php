...
<body>
    ...
    if (!empty($dados['SendRecupSenha'])) {
        ...
        if (($result_usuario) and ($result_usuario->rowCount() != 0)) {
            ...
            $query_up_usuario = "UPDATE tbusuarios 
            ...
            if ($result_up_usuario->execute()) {
                $link = "http://localhost/login/atualizar_senha.php?chave=$chave_recuperar_senha";

                try {

                    $mail->CharSet = "UTF-8";
                    $mail->isSMTP();
                    // Por conta da atual instabilidade do PHP Mail (pretendemos portar para outra API/função) utilizamos um SMTP fixo do Mailtrap.io
                    $mail->Host       = 'smtp.gmail.com';
                    $mail->SMTPAuth   = true;
                    $mail->Port = 587;
                    $mail->Username = 'trabalhotcc1304@gmail.com';
                    $mail->Password = 'lpjclmtutsnuzaaa';
                    $mail->SMTPSecure = 'tls';
